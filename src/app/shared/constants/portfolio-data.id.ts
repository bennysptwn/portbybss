// src/app/shared/constants/portfolio-data.id.ts
import type {
  PersonalInfo,
  NavLink,
  AvailabilityStatus,
...
export const PERSONAL_INFO_ID: PersonalInfo = {
  name: 'Benny Septiawan Salim',
  alias: 'bennysptwn a.k.a',
  title: 'Software Engineer — AI Enthusiast',
  tagline: 'Membangun sistem digital yang andal—dari alat otomatisasi dan pipeline data hingga platform yang aman.',
  avatarPath: 'benny.png',
...
export const AVAILABILITY_STATUS_ID: AvailabilityStatus = 'available';
export const SCHEDULING_LINK_ID = 'https://calendly.com/bennygho90/30min';

// ── Navigation Links ──────────────────────────────────────────────────────────

export const NAV_LINKS_ID: NavLink[] = [
  { label: 'Beranda', path: '/home', svgIcon: getIcon('nav-home') },
  { label: 'Tentang', path: '/about', svgIcon: getIcon('nav-about') },
  { label: 'Pengalaman', path: '/experiences', svgIcon: getIcon('nav-experiences') },
