// src/app/shared/constants/portfolio-data.en.ts
import type {
  PersonalInfo,
  SocialLink,
  NavLink,
...
export const PERSONAL_INFO_EN: PersonalInfo = {
  ...
  tagline: 'Building reliable digital systems—from automation tools and data pipelines to secure platforms.',
...
export const SOCIAL_LINKS_EN: SocialLink[] = [
...
export const AVAILABILITY_STATUS_EN: AvailabilityStatus = 'available';
export const SCHEDULING_LINK_EN = 'https://calendly.com/bennygho90/30min';
